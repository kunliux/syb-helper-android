...
import static com.shouyubang.android.inter.record.CommonUtils.SIZE_1;
import static com.shouyubang.android.inter.record.CommonUtils.SIZE_2;
import static com.shouyubang.android.inter.record.CommonUtils.getScreenHeight;
import static com.shouyubang.android.inter.record.CommonUtils.getScreenWidth;
...
public class RecordActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    public static Intent newIntent(Context packageContext, Integer videoId) {
    ...
    private void endRecord() {
        ...
        videoTime.stop();
        videoTime.setBase(SystemClock.elapsedRealtime());
        Intent intent = PlayActivity.newIntent(RecordActivity.this, videoFile.getAbsolutePath(), videoId);
